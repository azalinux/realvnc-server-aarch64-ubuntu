...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-ubuntu/releases/download/v7.5.1/realvnc-server-arm64-ubuntu-v7.5.1.deb
$ sudo dpkg -i realvnc-server-arm64-ubuntu-v7.5.1.deb
```
