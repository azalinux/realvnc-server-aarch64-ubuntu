...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-ubuntu/releases/download/v7.8.0/realvnc-server-arm64-ubuntu-v7.8.0.deb
$ sudo dpkg -i realvnc-server-arm64-ubuntu-v7.8.0.deb
```
